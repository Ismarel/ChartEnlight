...
open class ChartViewBase: NSUIView, ChartDataProvider, AnimatorDelegate
{
    ...
    open override func draw(_ rect: CGRect)
    {
        ...
        if _data === nil && noDataText.count > 0
        {
            ...
            let aling = NSMutableParagraphStyle()
            ...
            ChartUtils.drawMultilineText(
                ...
                [NSAttributedString.Key(rawValue: NSAttributedString.Key.font.rawValue): noDataFont,
                 NSAttributedString.Key(rawValue: NSAttributedString.Key.foregroundColor.rawValue): noDataTextColor, NSAttributedString.Key(rawValue: NSAttributedString.Key.paragraphStyle.rawValue): aling],
